...
///
/// Mocked classes will override all internal, public and open instance and class members, including methods, properties, and initializers.
/// Overridden initializers will set stubs in the mock for properties that are passed in.
...
public macro AddMock() = #externalMacro(module: "MockingMacros", type: "AddMockMacro")
