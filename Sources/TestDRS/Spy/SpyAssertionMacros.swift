...
) -> AssertWasCalledResult<Input, Output> = #externalMacro(module: "TestDRSMacros", type: "AssertWasCalledMacro")
...
) -> AssertWasCalledResult<(repeat each Input), Output> = #externalMacro(module: "TestDRSMacros", type: "AssertWasCalledMacro") where repeat each Input: Equatable
