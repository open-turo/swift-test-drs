...
) -> ExpectWasCalledResult<MatchingAnyAmount, Input, Output> = #externalMacro(module: "ExpectationMacros", type: "ExpectWasCalledMacro")
...
public macro expectWasCalled<each Input, Output>(
    ...
    returning outputType: Output.Type? = nil
) -> ExpectWasCalledResult<MatchingAnyAmount, (repeat each Input), Output> = #externalMacro(module: "ExpectationMacros", type: "ExpectWasCalledMacro") where repeat each Input: Equatable
...
public macro expectWasNotCalled<Input, Output>(
    ...
    taking inputType: Input.Type? = nil,
    returning outputType: Output.Type? = nil
) = #externalMacro(module: "ExpectationMacros", type: "ExpectWasNotCalledMacro")
