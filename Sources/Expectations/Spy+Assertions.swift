...
public extension Spy {
    ...
    static func assertStaticFunctionWasCalled<Input, Output>(
        ...
        getStaticBlackBox().assertWasCalled(function, signature: signature, file: file, line: line)
    }
    ...
    static func assertStaticFunctionWasCalled<each Input, Output>(
        ...
        getStaticBlackBox().assertWasCalled(function, signature: signature, expectedInput: repeat each expectedInput, file: file, line: line)
    }
    ...
    static func assertStaticFunctionWasNotCalled<Input, Output>(
        ...
        getStaticBlackBox().assertWasNotCalled(function, signature: signature, file: file, line: line)
    }
