...
) -> AssertWasCalledResult<MatchingAnyAmount, Input, Output> = #externalMacro(module: "ExpectationMacros", type: "AssertWasCalledMacro")
...
) -> AssertWasCalledResult<MatchingAnyAmount, (repeat each Input), Output> = #externalMacro(module: "ExpectationMacros", type: "AssertWasCalledMacro") where repeat each Input: Equatable
...
public macro assertWasNotCalled<Input, Output>(
    ...
    taking inputType: Input.Type? = nil,
    returning outputType: Output.Type? = nil
) = #externalMacro(module: "ExpectationMacros", type: "AssertWasNotCalledMacro")
