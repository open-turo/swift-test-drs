...
/// Defines possible positions of a function call relative to other function calls recorded by a certain Spy.
public enum FunctionCallPosition {
    /// The function was the first to be recorded by a certain Spy.
    case first
    /// The function was the last to be recorded by a certain Spy.
    case last
